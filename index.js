...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//Scope works from the inside outwards. nestedFunction reaches out to find internal from the partent functions. 
...
function lowerCaseNames(array) {
  const newList = array.map(function (item) {
...
function lowPopulationAnimals(array) {
  const newPopulation = array.filter(function (item) {
...
*/
function consume(itemOne, itemTwo, itemCB) {
  return itemCB(itemOne, itemTwo);
}
